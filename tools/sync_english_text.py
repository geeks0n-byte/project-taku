...
SECTIONS: list[tuple[str, str, callable]] = [
    ...
    (
        ...
        lambda k: k.startswith("HTP_"),
    ),
    (
        "03_levels_and_stars.txt",
        "Level select, difficulty, star goals",
        lambda k: k.startswith(("DIFF_", "STAR_", "STAT_", "UI_LEVEL", "UI_CORE", "UI_CUSTOM", "UI_SELECT", "UI_TAP_STARS", "LEVEL", "LOCKED", "CUSTOM_", "NO_", "TIME", "MOVES", "COUNTER_", "TIMES_UP")),
    ),
    (
        "04_ui_menus.txt",
        "Menus, options, confirmations, consent",
        lambda k: k.startswith(("UI_", "CONFIRM_", "SESSION_", "SAVE_", "CUSTOM_DELETED", "UNLOCK_")),
    ),
    (
        "05_gameplay_hud.txt",
    ...
    (
        ...
        lambda k: k.startswith(("SPLASH_", "CREDIT_")),
    ),
    (
        "07_game_flow.txt",
